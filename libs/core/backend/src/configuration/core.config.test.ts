import { extractKey } from '../utilities/key.shared.utils';
...
export const CoreConfigEnv: ICoreConfigEnv = {
    ...
    jwt: {
        jwtPrivateKey: extractKey(`${process.cwd()}/src/config/keys/jwtRS256.key`),
        jwtPublicKey: extractKey(`${process.cwd()}/src/config/keys/jwtRS256.key.pub`)
    },
    mailer: {
        service: 'gmail',
        host: 'smtp.gmail.com',
