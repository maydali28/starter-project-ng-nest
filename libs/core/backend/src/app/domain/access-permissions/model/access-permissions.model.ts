...
import { IsNotEmpty, IsArray, IsIn, ValidateNested, IsBoolean } from 'class-validator';
import { Roles, OrganizationRoles, BaseModel, schemaOptions, UserOrgPermissionsContract } from '@starter-project-ng-nest/core/global-contracts';
...
export class AccessPermissions extends BaseModel<AccessPermissions>{
    ...
    static get model(): ModelType<AccessPermissions> {
        return new AccessPermissions().getModelForClass(AccessPermissions, { schemaOptions });
    }
